...
#[ignore]
pub fn gen_parser() {
    let pest = Path::new(concat!(env!("CARGO_MANIFEST_DIR"), "./re0.pest"));
    let rs = Path::new(concat!(env!("CARGO_MANIFEST_DIR"), "./src/re0.rs"));
    ...
    let out = format!("pub struct Re0Parser;{}", derived);
